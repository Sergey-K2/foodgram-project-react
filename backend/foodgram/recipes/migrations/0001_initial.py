    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('Кг', 'Килограмм'), ('Гр', 'Грамм'), ('Мг', 'Миллиграм'), ('Шт', 'Штук')], max_length=100, verbose_name='Единицы измерения')),
            ],
            options={
                'ordering': ('-title',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ManyToManyField(related_name='recipe', to='recipes.Ingredient', verbose_name='Ингридиент')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='foll', to='recipes.recipe', verbose_name='Автор')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='foll', to=settings.AUTH_USER_MODEL, verbose_name='Подписчик')),
            ],
            options={
                'verbose_name': 'Подписка',
                'verbose_name_plural': 'Подписки',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('added', models.DateTimeField(auto_now_add=True, verbose_name='Дата и время публикации')),
                ('Recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='follow', to='recipes.recipe', verbose_name='Автор')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'author'), name="User can't subscribe on himself"),
        ),
    ]
